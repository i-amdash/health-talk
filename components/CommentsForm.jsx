...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className='bg-white bg-opacity-80 shadow-black shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className='mt-8'>
        ...
        className="transition duration-500 ease hover:bg-blue-900 inline-block bg-green-600 text-lg text-white rounded-full px-8 py-3 cursor-pointer"
        >
            Post Comment
        </button>
